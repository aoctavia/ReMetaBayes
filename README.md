...
type: software
authors:
  - family-names: Octaviani
    given-names: Aulia
    email: auliaoctavvia@gmail.com
    orcid: "https://orcid.org/0000-0000-0000-0000"   # optional: replace if you have one
...
identifiers:
  - type: doi
    value: "10.5281/zenodo.xxxxxxx"  # replace after creating Zenodo release
preferred-citation:
  type: article
  title: "ReMetaBayes: Entropy-Weighted Probabilistic RL for Autonomous Adaptation under Non-Stationarity"
  authors:
  ...
  year: 2025
  journal: "Preprint"
  notes: "Code, configs, and figures available in the repository."
```